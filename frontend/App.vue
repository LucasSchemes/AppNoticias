    ...
    <div v-else class="main-content">
      ...
      <div class="news-feed">
        ...
        <div v-for="(n, index) in noticias" :key="index" class="news-card">
          ...
          <small class="news-date">{{ new Date(n.data).toLocaleString() }}</small>
        </div>
      </div>
...
export default {
  data() {
    return {
      // VAPID PUBLIC KEY
      publicKey: "BN5o-ONGdVxvyV4G8wp79oAKfrtBqTcsx22YVQgDvqEY6ESXWLwIfAUBmuSEgLIdliy0qPEEGI7Kvt_CA45ZP7U", 
...
.btn-refresh { background: transparent; border: 1px solid #ccc; padding: 5px 10px; cursor: pointer; margin-bottom: 10px; border-radius: 4px; color: black;}
